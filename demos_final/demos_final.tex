...
%%%%%% 6 %%%%%%
\begin{itemize}
    \item [6)] \textbf{Probar que el valor de todo flujo es menor o igual que la capacidad de 
    todo corte y que si f es un flujo, entonces las siguientes afirmaciones son 
    equivalentes:
    \begin{itemize}
        \item [i)] $f$ es maximal
        \item [ii)] Existe un corte $S$ tal que $v(f) = cap(S)$ (y en este caso, $S$ es minimal)
